...
Original file is located at
    https://colab.research.google.com/drive/1uMv3O07lLsrzuH2VpaLr_kVm8nvc6CeV
"""
...
img=mpimg.imread('/content/data/with_mask/with_mask_185.jpg')
...
#image processing
#1. resizing trhe image

#2.coverting into numpy array
...
#convert image list and labl list into np array
X=np.array(data)
Y=np.array(labels)
...
if input_pred_label==1:
  ...
  print('the person is not wearing any mask')